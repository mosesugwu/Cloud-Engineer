...
curl -L -X POST -H "Accept: application/vnd.github+json" \
    ...
    https://api.github.com/repos/mosesugwu/Cloud-Engineer/actions/runners/registration-token > response.json 
...
cd $RUNNER_DIR
./config.sh --url https://github.com/mosesugwu/Cloud-Engineer --token $RUNNER_TOKEN <<EOL
